...
This is a sample template for dynamoDb - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name dynamodb --tail
```
...
#sam local invoke HelloWorldFunction --event event.json
sam local invoke -e .\event.json "CreateTableFunction"
